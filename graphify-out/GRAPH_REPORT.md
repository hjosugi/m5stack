...
Cohesion: 0.12
Nodes (17): 2026-07-31, 2026-08-01, 2026-08-01 Cardputer-Adv最新firmware構成, 2026-08-01 Cardputer mute再調査, 2026-08-01 my-m5docs最終統合, CardputerミュートとMarkdownサイト, OSSカスタムファームウェア調査, OSS調査 (+9 more)
...
Cohesion: 0.18
Nodes (11): 3.5 mm端子, Bruce 1.16の場合, Cardputer-Advをミュートする, M5LauncherからBruceを起動している場合, いまBruceの音を止める, 何が静かになるか, 公式UserDemoの場合, 参照した公式情報 (+3 more)
...
Cohesion: 0.29
Nodes (7): awesome listは仕様書ではない, Cardputer-Adv対応を見分ける, Cardputerコミュニティソフトの見方, 初回動作確認の順序, 参照先, 導入前チェック, 掲載内容の分類
